/**
 * Tool executor — shared logic for executing tools with permission checks.
 *
 * This module contains the common tool execution logic used by both
 ...
 * 
 * @returns The tool result and whether to continue to next tool
 */
...
/**
 * Finalize turn cost and yield turn_end event.
 */
export function finalizeTurn(yieldEvent: (event: { type: "turn_end"; turn: number; tokens: number; cost: number }) => void): void {
